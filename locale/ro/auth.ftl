...
subscriptionReactivation-content = Ciclul tău de facturare și plăți va rămâne același. Următoarea sumă percepută va fi de { $invoiceTotal } la data de { $nextInvoiceDateOnly }. Abonamentul tău se va reînnoi automat la fiecare perioadă 
