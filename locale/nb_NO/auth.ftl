...
subscriptionReactivation-content = Faktureringssyklusen og betalingen din vil forbli den samme. Din neste betaling vil være på { $invoiceTotal } den { $nextInvoiceDateOnly }. Abonnementet ditt fornyes automatisk hver 
