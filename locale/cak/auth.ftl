...
subscriptionReactivation-content = Ri retal apaktura' chuqa' atojik junam nub'än. Ri jun chik atojik ja ri pa { $invoiceTotal } pa { $nextInvoiceDateOnly }. Xtijalatäj ri rutgz'ib'axik ab'i' toq natöj ri apaktura', man keta ri' we 
