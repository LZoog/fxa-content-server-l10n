...
subscriptionReactivation-content = Allus ufetter-ik•im d uxelleṣ ad qqimen akken. Ssuma-k•m i d-itteddun ad tili d { $invoiceTotal } deg { $nextInvoiceDateOnly }. Amulteɣ-ik•im ad imuynet s wudem awurman yal tallit n ufetter anagar ma 
