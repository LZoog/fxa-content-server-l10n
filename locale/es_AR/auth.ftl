...
subscriptionReactivation-content = El ciclo de facturación y pagos seguirá siendo el mismo. El próximo cargo será de { $invoiceTotal } en { $nextInvoiceDateOnly }. La suscripción será automáticamente renovada en cada período de 
