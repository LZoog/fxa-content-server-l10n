...
subscriptionReactivation-content = Din faktureringsperiod och betalning förblir desamma. Din nästa faktura är på { $invoiceTotal } och dras den { $nextInvoiceDateOnly }. Din prenumeration förnyas automatiskt varje faktureringsperiod 
