...
subscriptionReactivation-content = Částka a platební období zůstane beze změny. Vaše další platba { $invoiceTotal } bude zaúčtována { $nextInvoiceDateOnly }. Vaše předplatné bude pravidelně automaticky obnovováno, dokud se 
