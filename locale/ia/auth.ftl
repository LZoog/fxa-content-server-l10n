...
subscriptionReactivation-content = Tu termino de facturation e pagamento remanera identic. Tu amonta successive sera { $invoiceTotal } le { $nextInvoiceDateOnly }. Tu subscription sera renovate automaticamente cata termino de 
