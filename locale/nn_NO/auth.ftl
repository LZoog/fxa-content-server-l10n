...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Takk for at du reaktiverer abonnementet på { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
#  $nextInvoiceDateOnly (String) - The date of the next invoice, e.g. 2016/01/20
subscriptionReactivation-content = Faktureringssyklusen og betalinga di vil vere som før. Den neste betalinga di vil vere på { $invoiceTotal } den { $nextInvoiceDateOnly }. Abonnementet ditt vert automatisk fornya kvar 
