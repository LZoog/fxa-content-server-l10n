...
subscriptionReactivation-content = Ciklus naplate i plaćanje ostat će isti. Sljedeće opterećenje iznosi { $invoiceTotal } na { $nextInvoiceDateOnly }. Tvoja će se pretplata automatski obnoviti, ukoliko je ne otkažeš.
